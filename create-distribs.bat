...
set name=HtmlTidyWrapper-1.2.i_a
...
7z a -r -ssw -y -x@create-distribs.exclude -x@create-distribs.exe.exclude  .\distrib\%name%.bin-win32.7z *.exe *.dll bin\*.* ChangeLog* ReadMe* COPYING* CREDITS* NEWS* AUTHORS*
